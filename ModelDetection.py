...
def main():
    ...
    car_segmentation_model = YOLO("CarSegmentation.pt", verbose=False)
    general_model = YOLO("yolov8n.pt", verbose=False)
    # car_orientation_model = YOLO("car_orientation_weights.pt")
    human_pose_model = YOLO("yolo11n-pose.pt", verbose=False)
    ...
    while True:
        ...
        detections = get_detections_from_image(frame, [general_model])
